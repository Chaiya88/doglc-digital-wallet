...
// src/simple-frontend.js
var HTML_CONTENT = `<!DOCTYPE html>
<html lang="th">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>\u{1F415} DOGLC Digital Wallet - Frontend Test</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="api-test">
            <h3>\u{1F517} Backend API Integration Test</h3>
        ...
        <div style="margin-top: 2rem;">
            <button class="btn" onclick="runSecurityTest()">\u{1F6E1}\uFE0F Security Test</button>
    ...
    <script>
        ...
        async function testBackendAPI() {
            ...
            resultsDiv.innerHTML = '\u{1F504} Testing backend connection...';
...
\u{1F4CA} Response: \${JSON.stringify(data, null, 2)}
\u23F1\uFE0F Response Time: \${Date.now() - Date.now()}ms
\u{1F310} Status: \${response.status}
                \`;
            } catch (error) {
                resultsDiv.innerHTML = \`
\u274C Backend Connection: FAILED
\u{1F6AB} Error: \${error.message}
\u{1F4A1} Tip: Make sure backend is running on port 8788
                \`;
            }
        }
        ...
        async function runSecurityTest() {
            ...
            resultsDiv.style.display = 'block';
            resultsDiv.innerHTML = '\u{1F6E1}\uFE0F Running security tests...';
            ...
            resultsDiv.innerHTML = \`
\u{1F6E1}\uFE0F SECURITY TEST RESULTS:
\${tests.join('\\n')}
...
\u{1F4CA} Total Requests: 10
\u2705 Success Rate: \${successRate}%
\u23F1\uFE0F Average Response Time: \${avgTime.toFixed(2)}ms
\u{1F680} Frontend Performance: \${avgTime < 100 ? 'EXCELLENT' : avgTime < 500 ? 'GOOD' : 'NEEDS IMPROVEMENT'}
...
\u{1F6AB} Error: \${error.message}
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('\u{1F415} DOGLC Frontend Worker Loaded');
...
var simple_frontend_default = {
  async fetch(request, env2, ctx) {
    ...
    headers.set(
      ...
      "default-src 'self' 'unsafe-inline' 'unsafe-eval' http://localhost:* https:; connect-src 'self' http://localhost:* https:; img-src 'self' data: https:;"
    );
    ...
    if (path.startsWith("/api/")) {
      try {
        const backendUrl = (env2.MAIN_BOT_URL || "http://localhost:8788") + path;
...
// .wrangler/tmp/bundle-OFSzoT/middleware-insertion-facade.js
var __INTERNAL_WRANGLER_MIDDLEWARE__ = [
  middleware_ensure_req_body_drained_default,
  middleware_miniflare3_json_error_default
];
var middleware_insertion_facade_default = simple_frontend_default;
...
// .wrangler/tmp/bundle-OFSzoT/middleware-loader.entry.ts
...
//# sourceMappingURL=simple-frontend.js.map
